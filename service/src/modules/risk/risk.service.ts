...
export class RiskService {
  ...
  private async createEventIfNew(ruleCode: string, userId: number, detail: object) {
  ...
  async resolveEvent(adminId: number, eventId: number, action: string, reason?: string) {
